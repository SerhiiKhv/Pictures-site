export const Perks = ({selected, onChange}) => {
    return (
        <>
            ...
            <label className="border border-gray-400 p-4 flex rounded-2xl gap-2 items-center">
                <input type="checkbox"/>
                <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" className="w-10 h-10" viewBox="-5.97 -5.97 43.38 43.38" xml:space="preserve" stroke="#000000"  transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)"><g id="SVGRepo_bgCarrier" ></g><g id="SVGRepo_tracerCarrier" ></g><g id="SVGRepo_iconCarrier"> <g> <g>
