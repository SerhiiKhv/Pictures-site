        ...
        <div>
            ...
            <div className="p-4 gap-2">
                {bookings?.length > 0 && bookings.map(booking => (
                    <Link to={`/account/bookings/${booking._id}`} key={booking._id} className="p-4 flex gap-2 bg-gray-200 rounded-2xl">
                        <div className="flex w-32 h-32 shrink-0">
                            <ImgPlace place={booking.place} className="rounded-2xl w-full"/>
                        </div>
